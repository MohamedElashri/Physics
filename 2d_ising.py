...
##  4- If this change is negative, accept such move. If change is positive, accept it with probability exp^{-dE/T}
##  5- repeat 2-4. 
...
#----------------------------------------------------------------------
def initialstate(N):   
    ''' generates a random spin configuration for a specific initial condition'''
...
N       = 1000         #  size of the lattice, N x N > we are working on L X L periodic lattice 
