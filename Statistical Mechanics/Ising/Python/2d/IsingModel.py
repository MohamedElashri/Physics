...
But I learned a nice thing from my desire to optimize code speed. it is the usage of Numba’s JIT compiler. 
read more about that here, http://melashri.net/url/b.
I also instead of using multiple nested loops I dragged all these into just one. 
Imagine running 50x50 lattice simulation in my older codes for hours (one took 6 hours) vs 30 minutes for the currect script. (On my Mac m1 Machine). 
...
# I use rich instead of tqdm mainly because tqdm doesn't play well with my favourite terminal (Iterm2). 
...
# It took about 30 minutes on my Mac meachine (not bad)
